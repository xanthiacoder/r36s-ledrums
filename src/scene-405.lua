...
local sceneNumber = 405

-- music data for this scene

-- filenames of samples to load
local sample = {
	[1] = "Doomcore-Dischord.wav",
	[2] = "Doomcore-Snare.wav",
	[3] = "Doomcore-Drum1.wav",
	[4] = "Doomcore-Drum2.wav",
	[5] = "Doomcore-Drum3.wav",
	[6] = "Doomcore-Haunting.wav",
	[7] = "Doomcore-Scary.wav",
	[8] = "Doomcore-Cymbal.wav",
	}
