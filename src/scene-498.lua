...
function K.start()
	...
	sfx[1] = love.audio.newSource("samples/ogg/"..sample[1], "static")
	sfx[2] = love.audio.newSource("samples/ogg/"..sample[2], "static")
	sfx[3] = love.audio.newSource("samples/ogg/"..sample[3], "static")
	sfx[4] = love.audio.newSource("samples/ogg/"..sample[4], "static")
	sfx[5] = love.audio.newSource("samples/ogg/"..sample[5], "static")
